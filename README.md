...
sample (7029 characters) size and more data fields. It was inspired by
the
...
74% of all spells parsed did not require any modification. 22% of were
...
80% of all weapons parsed did not require any modification. 15% of were
only able to be matched through the heuristics. A manual examination of
